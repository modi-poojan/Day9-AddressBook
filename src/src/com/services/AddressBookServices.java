...
public class AddressBookServices {
	...
	public boolean duplicateNames(String first, String last) {
		for (AddressBook addressBookList : addresslist) {
			for (ContactBook i : addressBookList.contactBook) {
	...
	public void searchContact() {
		...
		case 1:
			...
			for (AddressBook addressBookList : addresslist) {
				for (ContactBook contacts : addressBookList.contactBook) {
		...
		case 2:
			...
			String state = input.next();
			for (AddressBook list : addresslist) {
				for (ContactBook contact : list.contactBook) {
	...
	public void newAddressBook() {
		...
		if (check == false) {
			AddressBook addressBook = new AddressBook(addressbook_name);
	...
	public void displayAddressBook() {
		if (addresslist.isEmpty()) {
			...
			for (AddressBook name : addresslist) {
